        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className="tokenomics-layout surface-card enhanced-card">
            <div className="donut-stage">
              ...
              <div className="donut-legend"><span><i className="legend-liquidity" /> Liquidity</span><span><i className="legend-burn" /> Buy & burn</span><span>
                <i className="legend-dev" /> DEVELOPMENT</span></div>
