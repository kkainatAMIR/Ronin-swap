...
const emptySettings = { points_enabled: true, minimum_qualifying_swap_usd: 10, points_per_usd: 1, transaction_points_cap_enabled: false, transaction_points_cap: '', campaigns: [], swap_enabled: true, sol_rewards_enabled: false, platform_fee_enabled: false, platform_fee_bps: 0 }
...
export default function Admin() {
  ...
  return <main className="admin-shell">
    ...
    <section className="surface-card admin-panel admin-disabled-controls"><div><Eyebrow>Future controls</Eyebrow><h2>Rewards and fees remain protected.</h2><p>SOL rewards are OFF and platform fees are {settings.platform_fee_enabled ? 'enabled by configuration' : 'OFF'}; this dashboard does not send rewards or modify blockchain transactions.</p></div><Tag tone="neutral">SERVER CONTROLLED</Tag></section>
  </main>
}